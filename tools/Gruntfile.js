...
var destBase = '../applications/lupapiste/build/package/resources/public/oskari/';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            ...
            dist: ['../applications/lupapiste/build/package/resources/public/oskari']
        },
    ...
    grunt.registerTask('releaseManual', 'Release build', function (version, configs, defaultIconDirectoryPath, copyResourcesToApplications, skipDocumentation) {
        ...
        for (i = 0, ilen = configs.length; i < ilen; i += 1) {
            ...
            dest = destBase + appName + '/';
            imageDest = './' + appName + '/images/';
            options = {
                targetDir: destBase + appName,
