 ...
 */
Oskari.clazz.define('Oskari.lupapiste.bundle.shpimport.Flyout',
    ...
    function (instance, locale) {
        ...
        __name: 'Oskari.lupapiste.bundle.shpimport.Flyout',
        __templates: {
        ...
        __getFormValues: function(formObj) {
            var values = {};
            values.name = formObj.find('input[name=layer-name]').val();
            values.desc = formObj.find('input[name=layer-desc]').val();
            values.source = formObj.find('input[name=layer-source]').val();
            values.filename = formObj.find('input[name=file-import]').val().split('\\').pop();
        ...
        __finish: function(iframe, locale) {
            ...
            var msg = locale.finish.success.message;
            var json;
            var success = true;
            var formValues = this.__getFormValues(iframe.parent());
            ...
            if (success === true) {
                this.instance.addUserData(formValues, json);
            } else {
                title = null;
