...
function(instance) {
    ...
    this.template = jQuery('<div class="myplacesform">' +
            ...
            '<div class="field">' +
                loc.area.label + '<br/>' +
                '<input type="text" name="placearea" placeholder="" />' +  
            '</div>' +
            '<div class="field">' +
            	loc.length.label + '<br/>' +
            	'<input type="text" name="placelength" placeholder="" />' +  
            '</div>' +
        '</div>');
    ...
    getForm : function(categories) {
        ...
        if(this.initialValues) {
            ...
            ui.find('input[name=placearea]').attr('value', this.initialValues.place.area);
            ui.find('input[name=placelength]').attr('value', this.initialValues.place.length);
    ...
    getValues : function() {
        ...
        if(onScreenForm.length > 0) {
            ...
            var area = onScreenForm.find('input[name=placearea]').val();
            var length = onScreenForm.find('input[name=placelength]').val();
    ...
    setValues : function(data) {
        ...
        if(onScreenForm.length > 0) {
            ...
            onScreenForm.find('input[name=placearea]').val(data.place.area);
            onScreenForm.find('input[name=placelength]').val(data.place.length);
