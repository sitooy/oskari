...
function() {
     ...
     * @property __name
     */
    __name : 'BuildingConventionSearch',
    ...
    startExtension : function() {
        var me = this;
        this.plugins['Oskari.userinterface.Flyout'] = Oskari.clazz.create('Oskari.lupapiste.bundle.buildingconventionsearch.Flyout', this);
        this.plugins['Oskari.userinterface.Tile'] = Oskari.clazz.create('Oskari.lupapiste.bundle.buildingconventionsearch.Tile', this);
    },
    ...
    start : function() {
        ...
        if(sandbox._modulesByName["lupakartta"].conf.municipality !== "908") {
            return;
        }
